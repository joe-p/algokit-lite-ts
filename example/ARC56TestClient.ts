...
export class ARC56TestClient extends ARC56AppClient {
  ...
  params = (methodParams?: TypedMethodParams) => {
    return {
      foo: (inputs: Inputs): MethodParams => {
      ...
      optInToApplication: (): MethodParams => {
        return this.getParams({
      ...
      createApplication: (): MethodParams => {
        return this.getParams({
  ...
  static override create<TReturn = unknown>(
  ...
  static override create(
    ...
    return {
      createApplication: async (): Promise<{
        ...
        const { appId, appAddress, result, returnValue } =
